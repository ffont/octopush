...
try:
    ...
    cmd = 'bash -c'.split()
    print 'Cross-compiling in SDK'
    print '----------------------'
    args = """
    cd {}; 
    . {};
    cd /code/octopush/OctopushOS/Builds/ELKAudioOS
    ...
    AR=aarch64-elk-linux-ar make -j1 CONFIG=Release CFLAGS="-DJUCE_HEADLESS_PLUGIN_CLIENT=1 -Wno-psabi" TARGET_ARCH="-mcpu=cortex-a72 -mtune=cortex-a72" -i
